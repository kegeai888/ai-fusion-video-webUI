...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES (1, '1', 'init mysql', 'SQL', 'V1__init_mysql.sql', 1911405402, 'root', '2026-04-16 16:03:20', 2241, 1);
INSERT INTO `flyway_schema_history` VALUES (2, '2', 'add storage config', 'SQL', 'V2__add_storage_config.sql', 1449864662, 'root', '2026-04-16 16:03:20', 71, 1);
INSERT INTO `flyway_schema_history` VALUES (3, '3', 'add video prompt', 'SQL', 'V3__add_video_prompt.sql', -594898148, 'root', '2026-04-16 16:03:20', 163, 1);
INSERT INTO `flyway_schema_history` VALUES (4, '4', 'add video reference urls', 'SQL', 'V4__add_video_reference_urls.sql', -2111510436, 'root', '2026-04-16 16:03:21', 269, 1);
INSERT INTO `flyway_schema_history` VALUES (5, '5', 'add art style columns', 'SQL', 'V5__add_art_style_columns.sql', -1298944666, 'root', '2026-04-16 16:03:21', 124, 1);
INSERT INTO `flyway_schema_history` VALUES (6, '6', 'add system config', 'SQL', 'V6__add_system_config.sql', -1867064503, 'root', '2026-04-16 16:03:21', 95, 1);
INSERT INTO `flyway_schema_history` VALUES (7, '7', 'add storyboard item asset fields', 'SQL', 'V7__add_storyboard_item_asset_fields.sql', -995184251, 'root', '2026-04-16 16:03:21', 498, 1);
